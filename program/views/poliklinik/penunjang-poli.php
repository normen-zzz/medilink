   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Rekening Rawat Jalan</a></li>
                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="inputEmail3" class="col-sm-1">Klinik</label>
                      <div class="col-sm-3">
                    ...
                    <div class="checkbox">
                    <label class="col-sm-1"><b>Laki - laki</b></label>
                    <div class="col-sm-2">
                        <input type="checkbox" id="inputEmail3" placeholder="0" disabled="">
                    </div>
                  </div>
                  ...
                  <h3>Entry Penunjang</h3>
                  <form class="form-horizontal">
                    <div class="box-body">


                      <label for="inputEmail3" class="col-sm-1">Penunjang</label>
                      <div class="col-sm-1">
                        <select class="form-control">
                          <option>option 1</option>
                          <option>option 2</option>
                    ...
                    <label for="inputPassword3" class="col-sm-1">Jam</label>
                      ...
                      <label for="inputPassword3" class="col-sm-1">Jumlah</label>
                      <div class="col-sm-2">
                      ...
                      <label for="inputPassword3" class="col-sm-1">Harga Satuan</label>
                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="inputEmail3" placeholder="0">
                      </div>
                      ...
                      <label for="inputPassword3" class="col-sm-1">Diskon</label>
                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="inputEmail3" placeholder="0">
                      </div>
