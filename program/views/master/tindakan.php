      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Master Data Tindakan</h3>
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="checkbox btn pull-right">
                    <label>
                      <input type="checkbox"> Find Panel
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <label for="inputPassword3" class="col-sm-1">Biaya Dokter (BPJS)</label>
                ...
                <div class="form-group">
                  ...
                  <label for="inputPassword3" class="col-sm-1">Dokter</label>

                  <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="0">
                  </div>
                  <label for="inputPassword3" class="col-sm-1">Perawat</label>

                  <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="0">
                  </div>
                  <label for="inputPassword3" class="col-sm-1">Biaya Bidan</label>
                ...
                <div class="form-group">
                  ...
                  <label for="inputPassword3" class="col-sm-1">Ruang</label>

                  <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="0">
                  </div>
                  <label for="inputPassword3" class="col-sm-1">Over Head</label>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <center>Biaya RS</center>
                      </th>
                      <th>
                        <center>Biaya Dokter</center>
                      </th>
                      <th>
                        <center>Biaya Perawat</center>
                      </th>
                      <th>
                        <center>Biaya Bidan</center>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
