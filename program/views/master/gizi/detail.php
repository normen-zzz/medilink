      ...
      <div class="box">
        ...
        <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><center>Gizi ID</center></th>
				  <th><center>Nama Gizi</center></th>
                ...
                <tbody>
					<tr>
                      ...
                      <td><center>Diet Biasa (N)</center></td>
					  <td><center></center></td>
                      <td>
						<center>
                    ...
                    <tr>
                      ...
                      <td><center>Diet Lunak (B)</center></td>
					  <td><center></center></td>
                      <td>
						<center>
                    ...
                    <tr>
                      ...
                      <td><center>Diet Rendah Garam(N)</center></td>
					  <td><center></center></td>
                      <td>
						<center>
							<button type="button" class="btn btn-info" data-toggle="modal" data-target="#">
              ...
              <div class="modal-body">
                ...
                <thead>
                  <tr>
                    ...
                    <th><center>Nilai Bahan</center></th>
                    <th><center>Tipe Gizi</center></th>
                    <th><center>Nilai Gizi</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
