                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Gizi</h3>
                                <div class="box-header">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-gizi">Tambah Data
                                    </button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Tambah Data Gizi</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group col-sm-6">
                            <label for="exampleInputEmail1">Gizi Name</label>
                        ...
                        <div class="form-group col-sm-6">
                            <label for="exampleInputEmail1">Nilai Bahan</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="">
                        </div>
                    </div>
