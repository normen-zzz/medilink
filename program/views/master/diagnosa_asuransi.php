            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>6</td>
                                                <td>Asuransi Admedika Employee Health Card</td>
                                            </tr>
                                            <tr>
                                                <td>7</td>
                                                <td>Asuransi Admedika Healthcare Solution</td>
                                            </tr>
                                            <tr>
                                                <td>8</td>
                                                <td>Asuransi Admedika JMA Syariah</td>
                                            </tr>
                                            <tr>
                                                <td>9</td>
                                                <td>Asuransi AJ Sinarmas MSIG</td>
                                            </tr>
                                            <tr>
                                                <td>10</td>
                                                <td>Asuransi Ailianz</td>
                                            </tr>
                                            <tr>
                                                <td>11</td>
                                                <td>Asuransi Askrida</td>
                                            </tr>
                                            <tr>
                                                <td>12</td>
                                                <td>Asuransi Ayiya Astra Life</td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="col-sm-7">
                            <label>Entry Diagnosa : <i>BPJS Ketenagakerjaan</i></label>
                            <div class="box-body">
