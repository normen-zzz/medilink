                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="inputEmail3" placeholder="ID">
                      </div>

                      <label for="inputEmail3" class="col-sm-1">Kelas</label>
                      <div class="col-sm-3">
                    ...
                    <div class="form-group">
                      <label class="col-sm-1">kapasitas</label>
                      <div class="col-sm-2">
                    ...
                    <h3 class="box-title">Biaya - Biaya</h3>
                    ...
                    <div class="form-group">
                      ...
                      <label for="inputPassword3" class="col-sm-1">Jas-Wat</label>

                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="inputEmail3" placeholder="0">
                      </div>
                      <label for="inputPassword3" class="col-sm-1">Konsultasi</label>
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td href="<? base_url('master/rawatinap'); ?>">1</td>
                          <td>Kamar Bayi Sehat</td>
                          <td>1</td>
                          <td>Rpa/Rpm</td>
                          <td>2</td>
                          <td>150,000</td>
