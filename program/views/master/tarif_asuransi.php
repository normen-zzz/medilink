...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini fixed">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Master
        <small>Tarif Asuransi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Master</a></li>
        <li class="active">Tarif Asuransi</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Diagnosa</a></li>
                <li><a href="#tab_2" data-toggle="tab">Tindakan</a></li>
